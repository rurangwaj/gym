...
<TABLE border="0">
 ...
 <tr><td>   <font size="2" face="Times New Roman">Age*:</font> </td><td> <input type="text" name="age" placeholder="EX:17" maxlength="12" onKeyPress="return onlyNum(event)" required/></td></tr>
	  ...
	  <tr><td>   <font size="2" face="Times New Roman">Street*:</font> </td><td> <input type="text" name="street" placeholder="EX:Home" required/></td></tr>
	   <tr><td>   <font size="2" face="Times New Roman"><b>Upload image*:</b></font> </td>
