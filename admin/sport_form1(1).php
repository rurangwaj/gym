...
<CENTER>
<div class="header">
        	<font size="3" face="Times New Roman"><b>:. GAME REGISTRATION.:</b></font>
	    </div>
		<br/>
 <div class="content">
...
<TABLE border="0">
				<form name="form" method="post"  action="sports_send.php">

 <tr><td>   <font size="2" face="Times New Roman">SportName*:</font> </td><td> <input type="text" name="name" ></td></tr>
	 <tr><td>   <font size="2" face="Times New Roman">Description*:</font> </td><td> <input type="text" name="description" ></td></tr>
