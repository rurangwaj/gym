...
print"<script>window.alert('$error');window.location='client_registration.php';</script>";
 ...
 $select=mysql_query("select * from client where phone='$phone'")or die(mysql_error());
...
elseif($age>="16"){
			...
			street,reg_date,location)
			VALUES ('$clFname','$clLname','$gender','$age','$phone','$email','$address1',NOW(),'$location')");
