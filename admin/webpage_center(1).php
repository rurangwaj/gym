...
<center>
<br/>
<div style="background-image:url(images/page_center.png);padding: 0;-moz-border-radius: 15px;-webkit-border-radius: 15px;border-radius: 15px;
width:530px;height:390px;">
<br/>
<div id="stretch"><b>WELCOME ADMINISTRATOR</b></div>
<br/>
<div style="width:405px;height:200px;">
...
<br/>
            ...
            <font color="#000"><b>EMPLOYEES NUMBER::</b></font>
			<?php
								include('connection.php');
								$qry = mysql_query("SELECT Count('emp_id') FROM employees");
